                ...
                <div class="uk-child-width-1-3@m" uk-grid>
                    ...
                    <div>
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input uk-disabled" id="email" name="email" type="email" value="{{ $user->email }}" disabled>
                                <span class="uk-text-danger uk-text-warning">ایمیل قابل تغییر نمی‌باشد.</span>
                            </div>
                        </div>
                    </div>
                    <!--  Password -->
                    ...
                    <div>
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input" id="birthdate" name="birthdate" type="text" value="{{ isset($user->user_informations['birthdate']) ? jdate($user->user_informations['birthdate'])->format("Y/m/d") : null }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <!--  Save button -->
